...
public class Category implements AppenderAttachable {
	 ...
	 * category's inherited resource bundle. See also
	 ...
	 * stock Hierarchy implementation, then call its fireRemove. Custom
	 * repositories can implement HierarchyEventListener if they want remove
	 * notifications.
	 * 
	 * @param appender
